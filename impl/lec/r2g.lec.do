...
# Generated on: Wed Feb 11 10:20:52 CST 2026 (Wed Feb 11 02:20:52 UTC 2026)
...
set_log_file ./r2g.lec.log -replace

usage -auto -elapse

set_verification_information rtl_dig_top_synv_db

read_implementation_information fv/dig_top -revised dig_top_synv
...
set_naming_rule "" -parameter -golden
set_naming_rule "_" "_" -array_delimiter -golden
set_naming_rule "%s\[%d\]" -instance_array -golden
set_naming_rule "%s_reg" -register -golden
set_naming_rule "%L_%s" "%L\[%d\]_%s" "%s" -instance -golden
set_naming_rule "%L_%s" "%L\[%d\]_%s" "%s" -variable -golden
...
set_hdl_options -max_for_loop_size 10000

set_hdl_options -VERILOG_INCLUDE_DIR "sep:src:cwd"
add_search_path . -design -golden
read_design -enumconstraint -define SYN -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../../../hdl/dig_top/dig_top_inc.v
elaborate_design -golden -root {dig_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab ../../../impl/APR/eco/dig_top_sim.v.pre.v
...
#add_name_alias fv/dig_top/dig_top_synv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles ./r2g.lec.log
}
